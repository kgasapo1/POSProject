...
public class Query_Sales extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Selling ID", "Selling Date", "Customer Type", "Name", "Product ID", "Product Name", "Unit Price", "Quantity", "Sub-Total", "Discount", "Total"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Integer.class, java.lang.String.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Integer.class
            };
        ...
        jLabel2.setText("No. of Product Sold :");
    ...
    private void btnExecuteActionPerformed(java.awt.event.ActionEvent evt) {                                           
        ...
        try {
            try{
                ...
                while(rs.next())
                {
                    model.addRow (new Object[] {rs.getString("selling_id"),rs.getString("selling_date"),rs.getString("customer_type"),rs.getString("customer_name"),rs.getString("product_id"),rs.getString("product_name"),rs.getString("product_price"),rs.getString("customer_quantity"),rs.getString("customer_subtotal"),rs.getString("customer_discount"),rs.getString("customer_total")});
                }
            ...
            {
                JOptionPane.showMessageDialog(this,"Invalid entry! Error in connectivity!");
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Query_Sales.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Query_Sales().setVisible(true);
            }
        });
    }
